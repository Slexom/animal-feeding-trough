...
public class FeedingTroughBlock extends BlockWithEntity {
	...
	public static final EnumProperty<FeedingTroughContent> CONTENT = EnumProperty.of("content", FeedingTroughContent.class);
	...
	public FeedingTroughBlock(Settings settings) {
		super(settings);
		this.setDefaultState(this.stateManager.getDefaultState().with(LEVEL, 0).with(CONTENT, FeedingTroughContent.CARROT));
	}

	@Override
	protected void appendProperties(StateManager.Builder<Block, BlockState> stateManager) {
		stateManager.add(LEVEL);
		stateManager.add(CONTENT);
	}
